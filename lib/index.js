...
var name = "jishu-cli";
var version = "0.0.8";
var description = "JiShu lowcode platform commender-line interface(CLI).";
...
var repository = {
	type: "git",
	url: "git+https://github.com/jishu-lowcode/cli.git"
};
var author = "Allen Wong <xiaofuyesnew@qq.com>";
var license = "MIT";
var scripts = {
	build: "rollup -c"
};
...
var bugs = {
	url: "https://github.com/jishu-lowcode/cli/issues"
};
var homepage = "https://github.com/jishu-lowcode/cli#readme";
var dependencies = {
	chalk: "4.1.2",
	commander: "^8.3.0",
	inquirer: "^8.2.0",
...
const program = commander.exports.createCommand();
program.version(source.gray(`jishu-cli ${pkg.version}`));
program
    .command("build")
    .argument("[path]")
